...
/**
 * Class used to search statistics in solr and return a json formatted string
 *
 * @author Kevin Van de Velde (kevin at atmire dot com)
 * @author Mark Diggory (markd at atmire dot com)
 * @author Ben Bosman (ben at atmire dot com)
 * @author Peter Dietz (dietz.72 at osu dot edu)
 */
public class JSONSolrStatistics extends AbstractReader implements Recyclable {

    private static Logger log = Logger.getLogger(JSONSolrStatistics.class);
    ...
    public void setup(SourceResolver resolver, Map objectModel, String src, Parameters par) throws ProcessingException, SAXException, IOException {
        ...
        // TODO Do an authorization check to prevent user from searching on data their not supposed to...
        ...
        /* Don't need to load additional solr configs for solr/statistics
        InputStream is = null;
        try {
        ...
        if(props.getProperty("solr.log.server") != null)
        {
            this.solrServerUrl = props.getProperty("solr.log.server").toString();
        }
    ...
    public void generate() throws IOException, SAXException, ProcessingException {
        ...
        try {
            ...
            log.error("Error while getting json solr result for statistics", e);
            e.printStackTrace();
        }
